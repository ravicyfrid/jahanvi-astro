					...
					<div className="row">
						<div className="col-12">
							...
							<div className="card rounded-2 shadow-lg bg-white mb-2 position-relative">
								...
								/>
								<button type="button" className="bg-white border-0 rounded-2 p-2 mt-1 me-1 position-absolute top-0 end-0">
								...
								<div className="card-body">
									<div className="d-flex justify-content-between mb-2">
										<div className="user-info">
											...
											<p className="mb-0"><small>05826</small></p>
										</div>

										<div className="user-info">
											<h6 className="mb-0">Gemstones
											</h6>
											<p className="mb-0"><small>Natural Opal</small></p>
										</div>
									...
									<div className="d-flex justify-content-between mb-2">
										<div className="user-info">
											...
											<p className="mb-0"><small>13 oct 2025 14:23</small></p>
										</div>
