import { Astro, Astro2, Astro3, BlueTopaz, CategoryIcon, CatsEye, CoralImg, genestroImg, OpalImg, PearlMoti, PlaceHolder } from "@/assets/images"
    ...
    <>
      <section className="gems-details-mobile">
        <div className="card-header shadow-sm bg-white border-bottom p-3 sticky-sidebar d-flex justify-content-between">
          ...
          <button type="button" className="border-0 bg-white"> <Image src={CategoryIcon} className="icon me-1 img-fluid" height={20} width={20} alt="Category icon" /></button>
        </div>
            ...
            <div className="col-12">
              <div className="card mb-3 rounded-2 mb-2 ps-0 gemes-details-card-box">
                <div className="row g-0">
                  <div className="col-4">
                    <Image src={OpalImg} className="icon card-img-top rounded-2" height={100} width={100} alt="Opal Img" />
                  </div>
                  <div className="col-8 ps-2 d-flex align-items-center">
                    <div className="card-body py-1 px-1">
                      <h5 className="card-title text-primary">Opal</h5>
              ...
              <div className="card mb-3 rounded-2 mb-2 ps-0 gemes-details-card-box">
                <div className="row g-0">
                  ...
                  <div className="col-8 ps-2 d-flex align-items-center">
                    <div className="card-body py-1 px-1">
                      <h5 className="card-title text-primary">Coral (Moonga)</h5>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="card mb-3 rounded-2 mb-2 ps-0 gemes-details-card-box">
                <div className="row g-0">
                  ...
                  <div className="col-8 d-flex align-items-center ps-2">
                    <div className="card-body py-1 px-1">
                      <h5 className="card-title text-primary">Blue Topaz</h5>
      ...
      <nav className="navbar fixed-bottom bg-white border-top  align-items-center py-2 footer-menu-list justify-content-center shadow-lg ">
