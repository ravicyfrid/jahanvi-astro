												...
												<div className="booking-card">
													<div className="d-flex justify-content-between align-items-center">
														...
														<div className="d-flex gap-2">
															<button type="button" className="btn success-button border-0" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight">Chat</button>
															<button type="button" className="order-failed border-0">Order Failder</button>
														</div>
													</div>
													<hr />
